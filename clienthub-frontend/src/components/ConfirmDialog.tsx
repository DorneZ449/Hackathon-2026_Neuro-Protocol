      ...
      <div className="card w-full max-w-md p-6">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="inline-flex items-center justify-center rounded-xl bg-red-600 px-4 py-2.5 font-medium text-[var(--primary-contrast)] transition hover:bg-red-700 disabled:opacity-60"
            disabled={busy}
          >
