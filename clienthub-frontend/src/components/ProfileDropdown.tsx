  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 sm:gap-3 px-2 sm:px-4 py-2 bg-[var(--surface-hover)] rounded-lg hover:bg-[var(--surface-hover)] transition-colors"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 surface rounded-lg shadow-lg border border-app py-1 z-[100]">
          ...
          <button
            ...
            className="w-full px-4 py-3 text-left text-sm text-app hover:bg-[var(--surface-hover)] flex items-center gap-3"
          >
          ...
          <div className="border-t border-app mt-1 pt-1">
            <button
              ...
              className="w-full px-4 py-3 text-left text-sm text-red-600 hover:bg-[var(--danger-bg)] flex items-center gap-3"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
