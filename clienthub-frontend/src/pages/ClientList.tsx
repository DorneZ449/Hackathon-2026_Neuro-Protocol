...
const ClientList: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {/* Поиск и фильтры */}
      <div className="surface rounded-xl shadow-sm border border-app p-6 mb-6">
        ...
        {(searchTerm || tagFilter || companyFilter) && (
          <div className="mt-4 flex items-center gap-2">
            ...
            <button
              ...
              className="ml-2 text-sm text-muted hover:text-app underline"
            >
              Очистить всё
            </button>
          </div>
      ...
      {clients.length > 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            {clients.map((client: Client) => (
              <div
                ...
                className="surface p-6 rounded-xl shadow-sm hover:shadow-md transition-all cursor-pointer border border-app hover:border-blue-200"
              >
        ...
        <div className="surface rounded-xl shadow-sm border border-app p-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-app mb-2">Клиенты не найдены</h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="surface rounded-xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-app">
              <h2 className="text-2xl font-bold text-app">Новый клиент</h2>
            </div>
